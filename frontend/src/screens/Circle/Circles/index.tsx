...
export function CirclesScreen({ onModalStateChange, navigation }: CirclesScreenProps) {
  ...
  const openCircleWithModal = (circle: Circle, openModal: 'assign' | 'invite' | 'settings') => {
    handleNavigate('circle-home', {
      circleId: circle.id,
      circleName: circle.name,
      inviteCode: circle.inviteCode,
  ...
  const handlePressIn = (circleId: number | string) => {
          ...
          <Animated.View style={styles.actionSheet}>
            ...
            <Pressable
              onPress={() => {
                ...
                if (circle) openCircleWithModal(circle, 'assign');
            ...
            >
              ...
              <View style={styles.actionSheetText}>
                <Text style={styles.actionSheetTitle}>Assign Mission</Text>
                <Text style={styles.actionSheetSubtitle}>Create a new mission</Text>
              </View>
            </Pressable>
            ...
            <Pressable
              onPress={() => {
                const circle = circles.find(c => c.id === longPressedCard);
                if (circle) openCircleWithModal(circle, 'invite');
                setLongPressedCard(null);
              }}
              style={({ pressed }) => [
                styles.actionSheetItem,
            ...
            >
              ...
              <View style={styles.actionSheetText}>
                ...
                <Text style={styles.actionSheetSubtitle}>Share invite link</Text>
              </View>
            </Pressable>
            ...
            <Pressable
              onPress={() => {
                const circle = circles.find(c => c.id === longPressedCard);
                if (circle) openCircleWithModal(circle, 'settings');
                setLongPressedCard(null);
              }}
              style={({ pressed }) => [
                styles.actionSheetItem,
            ...
            >
              ...
              <View style={styles.actionSheetText}>
                <Text style={styles.actionSheetTitle}>Circle Settings</Text>
                <Text style={styles.actionSheetSubtitle}>Manage circle options</Text>
              </View>
            </Pressable>
