...
export const SETTINGS_SECTIONS: SettingsSection[] = [
  {
    title: 'Preferences',
    items: [
      { id: '1', iconName: 'notifications', iconColor: '#F59E0B', title: 'Push Notifications', type: 'navigation', navigateTo: 'NotificationSettings', subtitle: 'Customize alerts' },
  ...
  },
  {
    title: 'Integrations',
    items: [
      { id: '9', iconName: 'calendar', iconColor: '#F43F5E', title: 'Calendar & Apps', type: 'navigation', navigateTo: 'Integrations', subtitle: 'Sync calendars, connect apps' },
    ],
  },
  {
    title: 'Account',
