  ...
  const renderContent = () => {
    switch (voiceState) {
      ...
      case 'processing':
        return (
          <View style={s.row}>
            <Ionicons name="sparkles" size={18} color="rgba(185, 88, 255, 0.9)" />
        ...
        return (
          <View style={s.column}>
            <View style={s.speakingHeader}>
              <Ionicons name="volume-high" size={16} color="rgba(185, 88, 255, 0.8)" />
